...
namespace OpenFrp.UI
{
    public partial class Config
    {
        ...
        /// Appdata/OpenFrp的位置
        /// </summary>
        public static readonly string FolderPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\OpenFrp";
        ...
        /// config.ini的位置
        /// </summary>
        public readonly string configpath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\OpenFrp\\config.ini";
