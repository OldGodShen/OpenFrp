...
namespace OpenFrp.UI
{
    public class FrpServer
    {
        ...
        /// Appdata/OpenFrp的位置
        /// </summary>
        private readonly string FolderPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\OpenFrp";

        /// <summary>
        /// 将api.openfrp.net上的一条节点信息转换成FrpServerModel
        /// </summary>
        /// <param name="Content">将api.openfrp.net上的节点信息</param>
        ...
        /// <summary>
        /// 将api.openfrp.net上的全部节点列表信息转换为FrpServerList的Array
        /// </summary>
        /// <param name="Content">api.openfrp.net上返回的字符串</param>
        /// <returns></returns>
